...
import { Home, Users, MessageSquareText, Settings, LifeBuoy, LogOut, Building2, Loader2, CalendarClock, MessageCircle, User as UserIconLucide, Users2, MessageSquarePlus, FileText, Wifi, AlertTriangle, ChevronDown, UserMinus, UserPlus, Code2, ListTodo, Smartphone } from "lucide-react";
...
const navItems = [
  ...
  { 
    ...
    subItems: [
      ...
      { href: "/device-management", label: "Device Management", icon: Smartphone },
    ]
  },
