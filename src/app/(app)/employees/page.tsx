...
async function getEmployees(): Promise<Employee[]> {
  ...
  const data: Employee[] = [
    ...
    { id: "5", name: "Edward Scissorhands", employeeId: "EMP005", department: "HR", role: "HR Business Partner", email: "edward.s@example.com", phone: "555-0105", startDate: "2019-11-05", status: "Inactive", avatar: "https://placehold.co/40x40/A4E6E1/FFFFFF.png", company: "Synergy Corp" },
    ...
    { id: "7", name: "George Jetson", employeeId: "EMP007", department: "Finance", role: "Accountant", email: "george.j@example.com", phone: "555-0107", startDate: "2023-01-30", status: "Active", company: "Innovatech Solutions" },
    ...
    { id: "10", name: "Jack Sparrow", employeeId: "EMP010", department: "Marketing", role: "Content Creator", email: "jack.s@example.com", phone: "555-0110", startDate: "2024-01-10", status: "Active", company: "Innovatech Solutions" },
...
export default async function EmployeesPage() {
  ...
  const uniqueCompanies = [...new Set(employees.map(emp => emp.company).filter(Boolean))] as string[];
